...
function GokensMarketplace() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 text-white">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex space-x-6">
                ...
                <Link href="/stats" className="hover:text-purple-400 transition">Stats</Link>
                <a
      ...
      {/* Status Bar */}
      {txStatus.type && (
        <div className={`border-b px-4 py-2 ${txStatus.type === 'success' ? 'bg-green-500/10 border-green-500/20' :
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex space-x-4 mb-8">
          <button
            ...
            className={`px-6 py-3 rounded-lg transition ${activeTab === 'art'
          ...
          <button
            ...
            className={`px-6 py-3 rounded-lg transition ${activeTab === 'gaming'
                ? 'bg-gradient-to-r from-purple-600 to-pink-600'
                : 'bg-gray-800 hover:bg-gray-700'
              }`}
          >
              ...
              {gameAssets.map((asset) => (
                <div key={asset.id} className="bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden border border-purple-500/20 hover:border-purple-500/50 transition">
                  <div className="relative">
                    ...
                    <span className={`absolute top-4 right-4 px-3 py-1 rounded-lg text-sm font-bold ${asset.rarity === 'Mythic' ? 'bg-red-500' :
